// Increases size and speed of player.
...
async function main() {
    ...
    page.on('request', interceptedRequest => {
      if (interceptedRequest.url().endsWith('player.js')) {
        interceptedRequest.respond({
          status: 200,
          contentType: 'application/javascript',
          body: fs.readFileSync('javascriptManipulation/cyberking.uk/challenge/static/player.js', 'utf8')
        });
      } else {
